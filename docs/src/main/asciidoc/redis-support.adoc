...
See link:https://github.com/Azure-Samples/azure-spring-boot-samples/tree/spring-cloudhsrjsjss-azure_{project-version}[azure-spring-boot-samples] for more details.
